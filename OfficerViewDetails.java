...
public class OfficerViewDetails extends JFrame {

    public OfficerViewDetails() {
        setTitle("AOMA-Heritage Monitor - View Details (OFFICER)");
        ...
        officerPanel.add(reportTypePanel);
        ...
        officerPanel.add(reportContainer);
        ...
        Runnable applySessionSelection = () -> {
            ...
            if (overall == OmaResultsModel.Severity.OK) {
                ...
                recoText = "Continue monitoring. Request an engineering review only if the risk level increases.";
            } else if (overall == OmaResultsModel.Severity.WARNING) {
                statusText = "STATUS: REVIEW REQUIRED";
                actionText = "ACTION: REQUEST ENGINEERING REVIEW";
                descText = "One or more indicators are out-of-tolerance. A focused review is recommended to protect heritage fabric.";
                recoText = "Coordinate with a structural engineer and heritage conservator before any intervention.";
            } else {
                statusText = "STATUS: UNSAFE / URGENT REVIEW";
                actionText = "ACTION: ESCALATE IMMEDIATELY";
                descText = "Critical out-of-tolerance indicators were detected. Treat as urgent until verified by a qualified professional.";
                recoText = "Restrict access if needed and initiate an urgent engineering + conservation review.";
            }
