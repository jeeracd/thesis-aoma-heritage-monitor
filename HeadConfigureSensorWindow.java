...
public class HeadConfigureSensorWindow extends JFrame {

    public static HeadConfigureSensorWindow instance;
    ...
    public HeadConfigureSensorWindow() {
        instance = this;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HeadConfigureSensorWindow::new);
    }
}
