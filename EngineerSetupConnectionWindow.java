...
public class EngineerSetupConnectionWindow extends JFrame {
    ...
    public static EngineerSetupConnectionWindow instance;
    ...
    @Override
        ...
        JLabel statusOverviewSubheaderLabel = new JLabel(
                "Welcome, Structural Engineer. Below is the real-time safety and serviceability status of all heritage structures under your jurisdiction.",
                SwingConstants.CENTER
        );
