...
public class OfficerConfigureSensorWindow extends JFrame {

    public static OfficerConfigureSensorWindow instance;
    ...
    public OfficerConfigureSensorWindow() {
        instance = this;
    ...
    @Override
        ...
        JButton configureSensorBtn = new JButton("Configure Sensor");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(OfficerConfigureSensorWindow::new);
    }
}
