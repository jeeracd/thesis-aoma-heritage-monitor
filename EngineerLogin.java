...
public class EngineerLogin extends JFrame {

    private JButton btnHead, btnEngineer, btnOfficer;

    public EngineerLogin() {
        setTitle("AOMA-Heritage Monitor - Structural Engineer Login");
        setSize(650, 600);
        ...
        JLabel roleTitle = new JLabel("Structural Engineer");
        roleTitle.setAlignmentX(Component.CENTER_ALIGNMENT);
        roleTitle.setFont(new Font("Arial", Font.BOLD, 16));

        JTextArea description = new JTextArea(
            "Enter the technical portal for automated operational modal analysis. " + 
            "If you are a Structural Engineer, log in here to monitor real-time vibration data," + 
            "analyze structural integrity logs, and submit technical health assessments for heritage buildings."
        );
