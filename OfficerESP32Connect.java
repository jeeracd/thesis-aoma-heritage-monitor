...
For Mac/Linux
javac -cp .:jserialcomm-2.11.4.jar OfficerESP32Connect.java
java  -cp .:jserialcomm-2.11.4.jar OfficerESP32Connect
...
public class OfficerESP32Connect extends JFrame implements ActionListener {
