...
public class HeadDashboardUserSettings extends JFrame {

    public HeadDashboardUserSettings() {
        setTitle("AOMA-Heritage Monitor - Head Dashboard");
    ...
    private JPanel createMainPanel() {
        ...
        tabs.addTab("Email & Password", new HeadDashboardEmailPassword().createEmailPasswordTab());
        tabs.addTab("Notifications", new HeadDashboardNotifications().createNotificationsTab());
    ...
    saveButton.addActionListener(e -> {
        JOptionPane.showMessageDialog(
                HeadDashboardUserSettings.this,
