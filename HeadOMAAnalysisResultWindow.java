...
public class HeadOMAAnalysisResultWindow extends JFrame {

    public static HeadOMAAnalysisResultWindow instance;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HeadOMAAnalysisResultWindow::new);
    }
}
