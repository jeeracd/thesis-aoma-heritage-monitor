...
public class HeadLogin extends JFrame {
    ...
    public HeadLogin() {
        ...
        JLabel roleTitle = new JLabel("Local Government Unit Head");
        roleTitle.setAlignmentX(Component.CENTER_ALIGNMENT);
        roleTitle.setFont(new Font("Arial", Font.BOLD, 16));

        JTextArea description = new JTextArea(
                "Centralized management for project administrators. "
                        + "If you are an LGU Head, log in here to oversee all heritage sites, "
                        + "review structural reports, and manage department-wide analytics."
        );
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HeadLogin::new);
    }
}