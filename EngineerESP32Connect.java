...
For Mac/Linux
javac -cp .:jserialcomm-2.11.4.jar EngineerESP32Connect.java
java  -cp .:jserialcomm-2.11.4.jar EngineerESP32Connect
...
public class EngineerESP32Connect extends JFrame implements ActionListener {

    JButton ESP32ConnectButton;
    JLabel ESP32StatusLabel;

    EngineerESP32Connect() {
