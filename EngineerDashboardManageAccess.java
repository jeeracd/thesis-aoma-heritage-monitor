...
public class EngineerDashboardManageAccess extends JFrame {

    public EngineerDashboardManageAccess() {

        setTitle("AOMA-Heritage Monitor - Manage Access (ENGINEER)");
        ...
        JOptionPane.showMessageDialog(
                EngineerDashboardManageAccess.this,
    ...
    private void addMember(JPanel panel, int y, String role, String email) {
        ...
        // For STRUCTURAL ENGINEER, set role to "Owner" and disable dropdown
