...
public class HeadVibrationDataWindow extends JFrame {

    public static HeadVibrationDataWindow instance;
    ...
    public HeadVibrationDataWindow() {
        instance = this;
    ...
    @Override
        ...
        viewVibrationDataBtn.addActionListener(e -> {
            SwingUtilities.invokeLater(() -> {
                new HeadVibrationData();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HeadVibrationDataWindow::new);
    }
}
