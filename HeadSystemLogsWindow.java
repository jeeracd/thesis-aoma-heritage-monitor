...
public class HeadSystemLogsWindow extends JFrame {

    public static HeadSystemLogsWindow instance;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HeadSystemLogsWindow::new);
    }
}
