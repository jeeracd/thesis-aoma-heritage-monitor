...
public class OfficerSetupConnectionWindow extends JFrame {

    public static OfficerSetupConnectionWindow instance;
    ...
    public OfficerSetupConnectionWindow() {
        instance = this;
    ...
    @Override
        ...
        // HEADER 
        JLabel headerLabel = new JLabel("Setup & Connection");
        ...
        JLabel statusOverviewHeaderLabel = new JLabel(
                "Heritage Building Status Overview (Setup & Connection)",
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(OfficerSetupConnectionWindow::new);
    }
}
