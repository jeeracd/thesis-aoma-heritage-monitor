...
public class EngineerExportSensorData extends JFrame {

    public static EngineerExportSensorData instance;
    ...
    public EngineerExportSensorData() {
        instance = this;
    ...
    @Override
        ...
        systemLogs.setEnabled(false); // disabled as per current requirements
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(EngineerExportSensorData::new);
    }
}
