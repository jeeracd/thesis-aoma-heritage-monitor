...
public class HeadESP32StatusWindow extends JFrame {

    public static HeadESP32StatusWindow instance;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HeadESP32StatusWindow::new);
    }
}
