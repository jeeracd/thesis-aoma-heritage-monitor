...
public class HeadAboutAOMA extends JFrame {
    ...
    public HeadAboutAOMA() {
        ...
        JMenuItem aboutAOMA =
                new JMenuItem("About AOMA-Heritage Monitor");
        ...
        JLabel LGUHeadLabel =
                new JLabel("LGU HEAD ACCOUNT");

        LGUHeadLabel.setFont(
                new Font("Arial", Font.BOLD, 14)
        );

        LGUHeadLabel.setHorizontalAlignment(
        ...
        centerTitleLabel.setFont(
                new Font("Arial", Font.ITALIC | Font.BOLD, 20)
        );
        ...
        Image userImgScaled =
                userIcon.getImage().getScaledInstance(
                        26,
                        26,
                        Image.SCALE_SMOOTH
                );
        ...
        JLabel userIconLabel =
                new JLabel(new ImageIcon(userImgScaled));

        userIconLabel.setBorder(
        ...
        JMenuItem userSettings =
                new JMenuItem("User Settings");

        userSettings.addActionListener(e -> {

            dispose();

            new HeadDashboardUserSettings();
        });
        ...
        userIconLabel.setCursor(
                Cursor.getPredefinedCursor(Cursor.HAND_CURSOR)
        );

        // Show popup when clicked
        userIconLabel.addMouseListener(
                new java.awt.event.MouseAdapter() {
                    ...
                    public void mouseClicked(
                        ...
                        userMenu.show(
                                userIconLabel,
                                0,
                                userIconLabel.getHeight()
                        );
                    }
                }
        );

        centerPanelDescription.add(
                centerTitleLabel,
                BorderLayout.CENTER
        );
