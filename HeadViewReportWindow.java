...
public class HeadViewReportWindow extends JFrame {

    public static HeadViewReportWindow instance;
    ...
    @Override
        ...
        // HEADER 
        JLabel headerLabel = new JLabel("View Report");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HeadViewReportWindow::new);
    }
}
