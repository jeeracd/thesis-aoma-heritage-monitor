...
public class HeadSetupConnectionWindow extends JFrame {

    public static HeadSetupConnectionWindow instance;
    ...
    public HeadSetupConnectionWindow() {
        instance = this;
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(HeadSetupConnectionWindow::new);
    }
}
